/mob/living/basic/mouse/russ
	icon = 'russstation/icons/mob/animal.dmi'

/mob/living/basic/mouse/russ/clouse
	name = "Clouse"
	body_color = "clown"
...
/mob/living/basic/mouse/russ/clouse/Initialize()
	. = ..()
...
/mob/living/basic/mouse/russ/clouse/death(gibbed,toast)
	if(!gibbed)
...
/mob/living/basic/mouse/russ/clouse/jimmithy
	name = "Jimmithy"
	real_name = "Jimmithy"
	icon_state = "mouse_clown"
	icon_living = "mouse_clown"
