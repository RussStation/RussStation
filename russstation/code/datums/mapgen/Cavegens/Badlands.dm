...
/datum/map_generator/cave_generator/badlands
	open_turf_types = list(/turf/open/misc/asteroid/basalt/wasteland = 1)
	// no, you don't get nice things
	closed_turf_types = list(/turf/closed/mineral/random/badlands = 40, \
	...
	feature_spawn_list = list(/obj/structure/statue/bone/rib = 12, \
