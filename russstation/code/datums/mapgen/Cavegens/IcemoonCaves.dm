...
/datum/map_generator/cave_generator/icemoon
	...
	closed_turf_types = list(/turf/closed/mineral/random/snow/low_chance = 1)
...
/datum/map_generator/cave_generator/icemoon/surface
	...
	closed_turf_types = list(/turf/closed/mineral/random/snow/low_chance = 1, /turf/closed/mineral/random/snow = 4)
...
/datum/map_generator/cave_generator/icemoon/deep
	...
	closed_turf_types = list(/turf/closed/mineral/random/snow = 4, /turf/closed/mineral/random/snow/high_chance = 1)
