/obj/item/book/granter/crafting_recipe/dwarf
	...
	remarks = list("Urist withdraws from society and begins a mysterious construction!", "Magma is not a water source.", "If cow cheese is made from cow's milk, what is dwarven cheese made of?", "The carp has drowned..?", "This is a menacing iron spike. This object menaces with spikes of iron.", "Fat dwarves eating causes lag.", "Who knew the first Dwarf to go to space was a useless fisherdwarf?", "In a time before time, somebody attacked somebody.")
