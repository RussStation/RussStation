...
//GLOBAL_LIST_INIT(commando_names, world.file2list("strings/names/death_commando.txt")) honk -- replaced by our file
GLOBAL_LIST_INIT(commando_names, world.file2list("russstation/strings/russ_death_commando.txt"))
